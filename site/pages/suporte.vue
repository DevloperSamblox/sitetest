...
<div class="texto">
<p class="text-center yt text-2xl ">Como contatar o suporte ?</p>
<p class="text-center text-1xl opacity-75">Para contatar o suporte basta entra no Discord do back+
  <br>entrar no canal Suporte e abrir um ticket, respondemos nos dias:
  <br>segunda-feira, sexta-feira.
  <br>Em casos urgentes basta enviar uma mensagem pra DevMachine.
</p>
