...
<div class="">
  <p class="text-center text-2xl r">Sobre Back+</p>
  <p class="text-center text-1xl opacity-75">Somos um bot para a plataforma discord
    <br>Estamos pesquisando formas de melhorar o uso do seu servidor no discord
    <br>nosso unico objetivo e te ajudar a governar seu servidor no discard
    <br>do jeito que ele seja exemplar de tanta moderação
    <br>este bot e totalmente gratuito e fornece todos recursos necessarios
    <br>para moderação do seu servidor, diversão etc...
    <br>🔶🔶🔶🔶🔶🔶🔶🔶🔶🔶🔶🔶
  </p>
</div>
